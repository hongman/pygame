...
while True: #loop start  
    ...
    #Section5(agoose를 랜덤으로 생성해주는 부분입니다.)    
    agooseCount += 1 #루프를 한번 돌 때마다 agooseCount라는 변수에 +1을 시켜줍니다. 루프가 60으로 설정 되있으므로 1초동안 agooseCount는 60이 될 것이고, 
                                   #저희가 설정 한 NEWAGOOSE의 값보다 커질 경우 if문으로 들어갑니다.
